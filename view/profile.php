...
<div class="glass-card" style="max-width: 500px; margin: 40px auto; padding: 30px;">
    ...
    <div style="text-align: center; margin-bottom: 25px;">
        ...
        <div
            ...
            style="cursor:pointer; width: 80px; height: 80px; border-radius: 50%; margin: 0 auto 15px; overflow: hidden; border: 3px solid #2ecc71; display:flex; align-items:center; justify-content:center;"
    ...
    <form method="POST" enctype="multipart/form-data" id="profileForm">
        ...
        <div class="input-group" style="margin-top: 15px;">
            ...
            <p style="color:#777; font-size: 12px; margin-top:6px;">
                Click the profile picture above to change (Allowed: JPG/JPEG/PNG/WEBP Max 2MB)
            </p>
        </div>
